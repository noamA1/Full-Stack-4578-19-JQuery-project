  ...
  containerElement.append(`
    <div class = "about-text-box">
        ...
        <p class = "about-text">
            ...
            This project which is written in javascript and through jquery library, shows the virtual currencies available in the market today, almost 13 thousand different currencies, the information about the currencies I imported from https://api.coingecko.com/api/v3/coins API.
